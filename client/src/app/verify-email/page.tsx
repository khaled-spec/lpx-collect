          ...
          <Card className="shadow-xl border-0">
            ...
            <CardContent className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  <strong>Verification Complete:</strong> Your email {email} has been verified.
          ...
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-muted rounded-lg">
              <p className="text-xs text-muted-foreground text-center">
                <strong>Demo Mode:</strong> This is a demonstration of email verification.
                Use any of the demo codes above to test the verification process.
                In a real application, you would receive an actual verification code via email.
              </p>
            </div>
          </CardContent>
        </Card>
