  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Add up to 8 high-quality images of your product. The first image will be the main image.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {/* Upload Area */}
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="draft" className="flex-1">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Save your product without publishing. You can edit and publish later.
                      </p>
                    </div>
                  </Label>
                </div>
