...
const mockProduct = {
  ...
  description: "Near mint condition Charizard from Base Set 1999. This iconic Pokemon card is in excellent condition with minimal wear. Card has been stored in protective sleeve since acquisition.",
  price: 299.99,
          ...
          >
            ...
            <div>
              <p className="font-medium">
                {totalImages >= 8 ? "Maximum images reached" : "Click to upload more images"}
              </p>
...
export default function EditProductPage({ params }: { params: { id: string } }) {
  ...
  const [existingImages, setExistingImages] = useState<string[]>(mockProduct.images);
      ...
      >
        ...
        {product.status === "active" && (
          <Alert className="mb-6">
            ...
            <AlertDescription>
              This product is currently live and visible to buyers. Changes will take effect immediately after saving.
              <Button asChild variant="link" className="p-0 ml-2 h-auto">
                <a href={`/product/${product.id}`} target="_blank" className="inline-flex items-center gap-1">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    value={watch("rarity") || ""}
                    onValueChange={(value) => setValue("rarity", value || undefined)}
                  >
                    <SelectTrigger className="mt-1">
          ...
          <Card>
            ...
            <CardContent>
              <RadioGroup
                value={watchedStatus}
                onValueChange={(value) => setValue("status", value as "draft" | "active" | "paused")}
                className="space-y-3"
              >
                <div className="flex items-center space-x-2">
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    The product will be permanently removed from your store and all associated data will be lost.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
