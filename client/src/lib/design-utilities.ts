...
export const typography = {
  ...
  h3: cn("text-2xl md:text-3xl", "font-semibold", "leading-snug"),
  h4: cn("text-xl md:text-2xl", "font-semibold", "leading-snug"),
  h5: cn("text-lg md:text-xl", "font-medium", "leading-normal"),
  h6: cn("text-base md:text-lg", "font-medium", "leading-normal"),
...
export const animation = {
  ...
  transition: (
    type: "all" | "colors" | "opacity" | "shadow" | "transform" = "all",
  ) => {
    const transitionMap = {
      all: "transition-all",
