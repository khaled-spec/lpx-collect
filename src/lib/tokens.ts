 ...
 */
export const spacing = (key: keyof typeof tokens.spacing) =>
  tokens.spacing[key];
 ...
 */
export const duration = (key: keyof typeof tokens.transitions.duration) =>
...
export const generateCSSVariables = () => {
  return `
    :root {
      ...
      /* Sizes */
      ${Object.entries(tokens.sizes.icon)
        .map(([key, value]) => `--size-icon-${key}: ${value};`)
        .join("\n      ")}
