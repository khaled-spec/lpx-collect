...
export const typography = {
  ...
  fonts: {
    ...
    mono: {
      DEFAULT: 'var(--font-geist-mono), ui-monospace, "Cascadia Code", "Source Code Pro", Menlo, Monaco, monospace',
  ...
  presets: {
    // Hero text
    hero: {
      title: 'font-bold text-4xl md:text-5xl lg:text-6xl tracking-tight leading-tight',
      subtitle: 'text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed',
    },
