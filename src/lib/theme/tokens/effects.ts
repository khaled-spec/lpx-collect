...
export const effects = {
  ...
  shadows: {
    ...
    neumorphic: {
      ...
      concave: 'inset 2px 2px 5px rgb(0 0 0 / 0.1), inset -2px -2px 5px rgb(255 255 255 / 0.5)',
      convex: '2px 2px 5px rgb(0 0 0 / 0.1), -2px -2px 5px rgb(255 255 255 / 0.5)',
      pressed: 'inset 3px 3px 7px rgb(0 0 0 / 0.15), inset -3px -3px 7px rgb(255 255 255 / 0.5)',
    },
  ...
  masks: {
    ...
    fade: {
      ...
      horizontal: 'linear-gradient(to right, transparent 0%, black 5%, black 95%, transparent 100%)',
      vertical: 'linear-gradient(to bottom, transparent 0%, black 5%, black 95%, transparent 100%)',
    },
  },
