...
export const getComponentSize = (
  ...
  return {
    ...
    fontSize: getTypography(
      "body",
      size === "xs" ? "xs" : size === "sm" ? "sm" : size === "xl" ? "lg" : "md",
    ).fontSize,
  };
};
...
export const getButtonClasses = (
  ...
  const baseClasses =
    "inline-flex items-center justify-center whitespace-nowrap font-medium transition-all focus-visible:outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50";
