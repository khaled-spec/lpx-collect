        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Discover {filteredVendors.length} trusted sellers from our marketplace
            </p>
          </div>
          ...
          <div className="mb-6">
                ...
                {!isFilterExpanded && activeFilterCount > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    {selectedSpecialties.length > 0 && (
                      <span className="badge badge-secondary">
                        {selectedSpecialties.length} {selectedSpecialties.length === 1 ? 'specialty' : 'specialties'}
                      </span>
                    )}
                    {selectedRating !== 'all' && (
                      <span className="badge badge-secondary">
            ...
            {isFilterExpanded && (
              <div className="border-t border-border animate-slide-up grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 py-4">
                ...
                {/* Verified Only */}
                <div>
                  <label className="block text-xs font-medium text-muted-foreground mb-1.5">Verification</label>
                  <button
                    ...
                    {isSpecialtyOpen && (
                      <div className="dropdown-menu left-0 right-0 max-h-64 overflow-y-auto">
                        <button
                          ...
                          className={`dropdown-item ${
                            selectedSpecialties.length === 0 ? 'dropdown-item-active' : ''
                          }`}
                        >
                          All Specialties
                        </button>
                        {specialtyOptions.map(specialty => (
                          <button
                            ...
                            className={`dropdown-item ${
                              selectedSpecialties.includes(specialty) ? 'dropdown-item-active' : ''
                            }`}
                          >
                            {specialty}
                          </button>
                    ...
                    {isRatingOpen && (
                      <div className="dropdown-menu left-0 right-0">
                        <button
                          ...
                          className={`dropdown-item ${
                            selectedRating === 'all' ? 'dropdown-item-active' : ''
                          }`}
                        >
                          Any Rating
                        </button>
                        {[4.5, 4.0, 3.5, 3.0].map(rating => (
                          <button
                            ...
                            className={`dropdown-item ${
                              selectedRating === rating.toString() ? 'dropdown-item-active' : ''
                            }`}
                          >
                            {rating}+ Stars
                          </button>
                  ...
                  >
                    <div className={viewMode === 'list' ? 'flex items-center gap-4 flex-1' : ''}>
                      ...
                      <div className={cn(
                        ...
                        viewMode === 'grid' ? 'w-16 h-16 mb-4' : 'w-20 h-20 flex-shrink-0'
                      )}>
                      ...
                      <div className="flex-1">
                        ...
                        <div className={cn(
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span>{vendor.stats.positiveReviews}% satisfaction</span>
                          </div>
                          <div className="flex items-center gap-1">
