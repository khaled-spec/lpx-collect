      ...
      <main className="flex-grow">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              A confirmation email has been sent to <strong>{order.shippingAddress.email}</strong> with your order details and tracking information.
            </AlertDescription>
          </Alert>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your package will arrive by {new Date(order.estimatedDelivery).toLocaleDateString()}
                  </p>
                </div>
              </div>
            </CardContent>
