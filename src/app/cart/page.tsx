...
import { ShoppingCart, Package, Sparkles, TrendingUp } from "lucide-react";
              ...
              <div className="text-center py-20">
                ...
                <div className="space-y-4 mb-10">
                  ...
                  >
                    ...
                    Start exploring our collection of rare and valuable
                    collectibles!
                  </p>
                </div>
                  ...
                  <Card className="border-dashed border-2 bg-background/50">
                    <CardContent className="py-8">
                      <h3 className="font-semibold text-lg mb-6 flex items-center justify-center gap-2 tracking-tight">
                        <TrendingUp
                          className={cn(productStyles.forms.icon.md)}
                        />
                        Popular Categories
                      </h3>
