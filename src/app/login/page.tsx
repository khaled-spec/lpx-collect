        ...
        <div className="h-full flex items-center justify-center p-12">
          <div className="max-w-md space-y-6 text-center">
            ...
            <p className="text-muted-foreground text-lg">
              Access your collection, track orders, and discover new treasures in the premier marketplace for authentic collectibles.
            </p>
            <div className="pt-8 space-y-4">
              <div className="flex items-center gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Every item authenticated by experts</p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-left">
                <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Protected payments and buyer guarantee</p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-left">
                <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Join thousands of passionate collectors</p>
                </div>
              </div>
            </div>
          </div>
