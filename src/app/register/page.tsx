        ...
        <div className="h-full flex items-center justify-center p-12">
          <div className="max-w-md space-y-6 text-center">
            ...
            <p className="text-muted-foreground text-lg">
              Start your collecting journey with access to thousands of
              authentic, verified collectibles from trusted sellers worldwide.
            </p>
            <div className="pt-8 space-y-4">
              <div className="flex items-center gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Set up your collector account in seconds
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Explore curated collections and rare finds
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Every purchase protected and authenticated
                  </p>
                </div>
              </div>
            </div>
            <div className="pt-6 border-t">
              <p className="text-sm text-muted-foreground">
                Want to sell? You can apply to become a vendor from your
