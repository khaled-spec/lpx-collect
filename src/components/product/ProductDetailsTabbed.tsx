          ...
          <div className="space-y-4">
            ...
            {returns.accepted ? (
              ...
              <div className="text-sm text-muted-foreground">
                This item is not eligible for returns. Please review the product
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Your purchase is protected by our comprehensive buyer protection
                program. Shop with confidence knowing that we guarantee
                authenticity and condition as described.
              </p>
              ...
              <div className="p-3 bg-background rounded-lg">
                <p className="text-xs text-muted-foreground">
                  If you encounter any issues with your purchase, our dedicated
                  support team is available 24/7 to assist you. We'll work to
                  resolve any problems quickly and fairly.
                </p>
              </div>
            </div>
          </div>
